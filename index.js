...
function renderQuestionAndAnswers(questionAndAnswersString) {
  ...
  var currentQuestionAndAnswers = questionAndAnswersString;
...
//function isUsersAnswerCorrect(number, index) {
////passing getUserAnswer and getCorrectAnswer functions as arguments, so function can determine whether the user's answer is the same as the correct answer. If they are the same, function will return true. If they are not the same, function will return false.
//    event.preventDefault();
//    let var usersAnswer = $('input[name=`question-${number}-answers`]:checked').val();
//    let var correctAnswer = questionsAndAnswers[index].answer;
//    return usersAnswer===correctAnswer;
//    console.log('`isUsersAnswerCorrect` ran');
//}
...
//function afterUserClicksSubmit(didUserAnswer, answerTruthiness) {
//passing hasUserSelectedAnswer and isUsersAnswerCorrect, as arguments, this function controls what is done after the user clicks the submit button on an answer
//if user didn't select an answer, trigger an alert that tells them to select an answer
//   if (didUserAnswer === false) {
//     alert("You have to select an answer to move forward.");
//   }
  //otherwise, call isUsersAnswerCorrect function, which return either true or false, based on whether the user was correct
//   else {
//    return answerTruthiness(userAnswer, correctAnswer);
//  }
//    console.log('`afterUserClicksSubmit` ran');
//}

//these are all callback functions that will be called in the quizProgression function
...
//exposes the incorrect-answer feeback page, when the user answers a question incorrectly
//  $( ".js-incorrect-answer" ).removeClass("hidden");
...
//  $(".js-feedback-pages").on("click", "button", function(event) {
...
////listens for the user to select the "take quiz again" button, and triggers an event that takes the user back to the first page of the quiz
//    $(".js-results-page").on("click", "button", function(event) {
//    $( ".js-reults-pages" ).removeClass("hidden");
//    $( ".js-first-page" ).removeClass("hidden");
//    });
//    console.log('`quizStartOver` ran');
//}
...
//    }
//  }
console.log('`quizProgression` ran');
}
quizProgression();
